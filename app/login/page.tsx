        ...
        <div className="w-full max-w-md relative">
          ...
          <div className="bg-white p-8 rounded-xl border-4 border-black relative z-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <div className="flex justify-between mb-1">
                  ...
                  <Link href="/auth/forgot-password" className="text-sm text-[#FF7043] hover:underline">
                    Forgot password?
                  </Link>
                </div>
                <div className="relative">
              ...
              <div className="mt-6 relative">
                ...
                <button
                  type="submit"
                  className="relative z-10 w-full bg-[#26A69A] text-white font-medium py-3 px-4 rounded-md hover:bg-[#00897B] transition-colors border-2 border-black flex items-center justify-center"
                >
                  Log In
            ...
            <div className="mt-8 text-center text-sm text-gray-600">
              ...
              <Link href="/auth/signup" className="text-[#FF7043] font-medium hover:underline">
                Sign up
              </Link>
            </div>
          </div>
